...
export class ScheduleMakerApp {
  ...
  renderCurrentSchedule(){this.resultsView.render();} navigateSchedule(delta){if(this.state.navigateSchedule(delta))this.resultsView.render();} switchView(view){this.resultsView.switchView(view);}
  showCourseDetailModal(section){this.courseDetailView.show(section);}
  toggleCurrentBookmark(){this.scheduleActions.toggleBookmark(this.btnBookmark);}
  ...
  exportCurrentScheduleIcs(){return this.scheduleActions.exportIcs();}
