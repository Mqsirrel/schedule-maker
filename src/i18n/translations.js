...
export const translations = {
  ar: {
    ...
    toast_timetable_loaded: "تم استيراد الجدول بنجاح ({count} شعبة مضافة).",
    ...
    toast_duplicate_course: "المادة موجودة بالفعل في القائمة.",
    ...
    toast_export_png_success: "تم تصدير وحفظ صورة الجدول بنجاح!",
    toast_export_ics_success: "تم تصدير ملف التقويم (.ics) بنجاح!",
  ...
  en: {
    ...
    toast_timetable_loaded: "Timetable imported successfully ({count} sections added).",
    ...
    toast_duplicate_course: "Course is already in the list.",
    toast_course_not_found: "Course not found.",
    toast_invalid_course: "Check the course code and number.",
    toast_crns_copied: "Section numbers copied to clipboard.",
    toast_export_success: "Schedule exported successfully.",
    toast_export_png_success: "Schedule image saved successfully!",
    toast_export_ics_success: "Calendar (.ics) exported successfully!",
